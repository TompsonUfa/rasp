                ...
                <tr v-for="item in data " :key="item.id">
                    ...
                    <td>
                        <div class="table__btns">
                            <div class="btn btn_edit" @click=modalOpenEdit(item)>
                                    ...
                                    <g id="SVGRepo_iconCarrier">
                                        <g id="Edit / Edit_Pencil_01">
                                            <path id="Vector"
                                                ...
                                                stroke="rgb(64,199,129)" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round"></path>
                                        </g>
                                    </g>
                                </svg>
                            </div>
                            <div class="btn btn_delete" @click=modalOpenRemove(item)>
                                <svg fill="red" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="64px" height="64px"
                                    viewBox="0 0 482.428 482.429" xml:space="preserve" stroke="red">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier">
                                        <g>
